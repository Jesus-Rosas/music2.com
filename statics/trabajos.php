<section id="work" class="page-section page">
  <div class="container text-center">
    <div class="heading">
      <h2>Eventos</h2>
      <p>Nuestra intención como empresa musical es que la audiencia esté conectada con todos sus artistas favoritos</p>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div id="portfolio">
          <ul class="filters list-inline">
            <li> <a class="active" data-filter="*" href="#">Ver Todos</a> </li>
            <li> <a data-filter=".photography" href="#">Rock</a> </li>
            <li> <a data-filter=".branding" href="#">Pop</a> </li>
            <li> <a data-filter=".web" href="#">Regional</a> </li>
          </ul>
          <ul class="items list-unstyled clearfix animated fadeInRight showing" data-animation="fadeInRight" style="position: relative; height: 438px;">
            <li class="item branding" style="position: absolute; left: 0px; top: 0px;"> <a href="images/work/1.jpg" class="fancybox"> <img src="images/work/1.jpg" alt="">
              <div class="overlay"> <span>Amliar imágen</span> </div>
              </a> </li>
            <li class="item photography" style="position: absolute; left: 292px; top: 0px;"> <a href="images/work/2.jpg" class="fancybox"> <img src="images/work/2.jpg" alt="">
              <div class="overlay"> <span>Ampliar imágen</span> </div>
              </a> </li>
